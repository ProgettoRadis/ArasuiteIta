...
public class GUI extends FrameView {
	...
	public GUI(SingleFrameApplication app) {
		...
		try {
			...
			if (G.classicIcons)
				iconsPath = "classicIcons";
			else
				iconsPath = "ARASAACIcons";

			// Ugly, but only quick way found to resize PNGs without losing
			// transparency.
			toolBarButtonFileNew.setIcon(new ImageIcon(new ImageIcon(
					"resources" + File.separator + "imgToolbar"
							+ File.separator + iconsPath + File.separator
							+ "file-new.png").getImage().getScaledInstance(
					G.iconsSize, G.iconsSize, java.awt.Image.SCALE_SMOOTH)));
			toolBarButtonFileOpen.setIcon(new ImageIcon(new ImageIcon(
					"resources" + File.separator + "imgToolbar"
							+ File.separator + iconsPath + File.separator
							+ "file-open.png").getImage().getScaledInstance(
					G.iconsSize, G.iconsSize, java.awt.Image.SCALE_SMOOTH)));
			toolBarButtonFileSave.setIcon(new ImageIcon(new ImageIcon(
					"resources" + File.separator + "imgToolbar"
							+ File.separator + iconsPath + File.separator
							+ "file-save-as.png").getImage().getScaledInstance(
					G.iconsSize, G.iconsSize, java.awt.Image.SCALE_SMOOTH)));
			toolBarButtonEditUndo.setIcon(new ImageIcon(new ImageIcon(
					"resources" + File.separator + "imgToolbar"
							+ File.separator + iconsPath + File.separator
							+ "edit-undo.png").getImage().getScaledInstance(
					G.iconsSize, G.iconsSize, java.awt.Image.SCALE_SMOOTH)));
			toolBarButtonEditRedo.setIcon(new ImageIcon(new ImageIcon(
					"resources" + File.separator + "imgToolbar"
							+ File.separator + iconsPath + File.separator
							+ "edit-redo.png").getImage().getScaledInstance(
					G.iconsSize, G.iconsSize, java.awt.Image.SCALE_SMOOTH)));
			toolBarButtonEditCut.setIcon(new ImageIcon(new ImageIcon(
					"resources" + File.separator + "imgToolbar"
							+ File.separator + iconsPath + File.separator
							+ "edit-cut.png").getImage().getScaledInstance(
					G.iconsSize, G.iconsSize, java.awt.Image.SCALE_SMOOTH)));
			toolBarButtonEditCopy.setIcon(new ImageIcon(new ImageIcon(
					"resources" + File.separator + "imgToolbar"
							+ File.separator + iconsPath + File.separator
							+ "edit-copy.png").getImage().getScaledInstance(
					G.iconsSize, G.iconsSize, java.awt.Image.SCALE_SMOOTH)));
			toolBarButtonEditPaste.setIcon(new ImageIcon(new ImageIcon(
					"resources" + File.separator + "imgToolbar"
							+ File.separator + iconsPath + File.separator
							+ "edit-paste.png").getImage().getScaledInstance(
					G.iconsSize, G.iconsSize, java.awt.Image.SCALE_SMOOTH)));
			toolBarButtonPictogramsNextImage.setIcon(new ImageIcon(
					new ImageIcon("resources" + File.separator + "imgToolbar"
							+ File.separator + iconsPath + File.separator
							+ "pictograms-next-image.png").getImage()
							.getScaledInstance(G.iconsSize, G.iconsSize,
									java.awt.Image.SCALE_SMOOTH)));
			toolBarButtonPictogramsCompoundSplitWord.setIcon(new ImageIcon(
					new ImageIcon("resources" + File.separator + "imgToolbar"
							+ File.separator + iconsPath + File.separator
							+ "pictograms-compound-split-word.png").getImage()
							.getScaledInstance(G.iconsSize, G.iconsSize,
									java.awt.Image.SCALE_SMOOTH)));
			toolBarButtonPictogramsChangeName.setIcon(new ImageIcon(
					new ImageIcon("resources" + File.separator + "imgToolbar"
							+ File.separator + iconsPath + File.separator
			...
			toolBarButtonPictogramsInsertImage.setIcon(new ImageIcon(
					new ImageIcon("resources" + File.separator + "imgToolbar"
							+ File.separator + iconsPath + File.separator
							+ "pictograms-insert-image.png").getImage()
							.getScaledInstance(G.iconsSize, G.iconsSize,
									java.awt.Image.SCALE_SMOOTH)));
			toolBarButtonVoiceSintesys.setIcon(new ImageIcon(new ImageIcon(
					"resources" + File.separator + "imgToolbar"
							+ File.separator + iconsPath + File.separator
							+ "voice-sintesys.png").getImage()
					.getScaledInstance(G.iconsSize, G.iconsSize,
							java.awt.Image.SCALE_SMOOTH)));
			setToolBar(toolBar);
		} catch (Exception e) {
		...
		G.font = new Font(G.defaultFont.getName(), G.defaultFont.getStyle(),
				G.defaultFont.getSize());
		G.color = new Color(G.defaultColor.getRed(), G.defaultColor.getBlue(),
				G.defaultColor.getGreen());
		G.textBelowPictogram = G.defaultTextBelowPictogram;
		G.notFound = new ImageIcon(new ImageIcon("resources/404.jpg")
				.getImage().getScaledInstance(-1, G.imagesSize, 0));
		...
		menuEditFind.setAccelerator(KeyStroke.getKeyStroke(
				java.awt.event.KeyEvent.VK_F, java.awt.Event.CTRL_MASK));
		menuEditSelectAll.setAccelerator(KeyStroke.getKeyStroke(
				java.awt.event.KeyEvent.VK_E, java.awt.Event.CTRL_MASK));

		menuPictogramsNextImage.setAccelerator(KeyStroke.getKeyStroke(
				java.awt.event.KeyEvent.VK_F3, 0));
		menuPictogramsCompoundSplitWord.setAccelerator(KeyStroke.getKeyStroke(
				java.awt.event.KeyEvent.VK_F4, 0));
		menuPictogramsChangeName.setAccelerator(KeyStroke.getKeyStroke(
				java.awt.event.KeyEvent.VK_F5, 0));
		menuPictogramsInsertImage.setAccelerator(KeyStroke.getKeyStroke(
				java.awt.event.KeyEvent.VK_F6, 0));
		menuVoiceSintesys.setAccelerator(KeyStroke.getKeyStroke(
				java.awt.event.KeyEvent.VK_F7, 0));

		menuHelpShowHelp.setAccelerator(KeyStroke.getKeyStroke(
				java.awt.event.KeyEvent.VK_F1, 0));

		this.getFrame().setTitle("AraWord");
		this.getFrame().pack();
		this.getFrame().setIconImage(
				Toolkit.getDefaultToolkit().getImage("resources/logo.png")); // Application
																				// logo
		...
		this.getFrame().addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				...
				if (JOptionPane.showConfirmDialog(getFrame(),
						TLanguage.getString("FILE_MENU_EXIT_WARNING"),
	...
	private void setApplicationLanguage() {
		...
		menuFileExportImage.setText(TLanguage
				.getString("FILE_MENU_EXPORT_IMAGE"));
		...
		menuTextPlacementAbovePictogram.setText(TLanguage
				.getString("TEXT_MENU_PLACEMENT_ABOVE_PICTOGRAM"));
		menuTextPlacementBelowPictogram.setText(TLanguage
				.getString("TEXT_MENU_PLACEMENT_BELOW_PICTOGRAM"));
		menuTextToUpperCase.setText(TLanguage
				.getString("TEXT_MENU_TO_UPPER_CASE"));
		menuTextToUpperCaseActiveElement.setText(TLanguage
				.getString("TEXT_MENU_TO_UPPER_CASE_ACTIVE_ELEMENT"));
		menuTextToUpperCaseAllElements.setText(TLanguage
				.getString("TEXT_MENU_TO_UPPER_CASE_ALL_ELEMENTS"));
		menuTextToLowerCase.setText(TLanguage
				.getString("TEXT_MENU_TO_LOWER_CASE"));
		menuTextToLowerCaseActiveElement.setText(TLanguage
				.getString("TEXT_MENU_TO_LOWER_CASE_ACTIVE_ELEMENT"));
		menuTextToLowerCaseAllElements.setText(TLanguage
				.getString("TEXT_MENU_TO_LOWER_CASE_ALL_ELEMENTS"));
		menuTextDocumentLanguage.setText(TLanguage
				.getString("TEXT_MENU_DOCUMENT_LANGUAGE"));
		...
		menuPictogramsNextImage.setText(TLanguage
				.getString("PICTOGRAMS_MENU_NEXT_IMAGE"));
		menuPictogramsCompoundSplitWord.setText(TLanguage
		...
		menuVoiceSintesys.setText(TLanguage
				.getString("TOOLS_MENU_VOICE_SINTESYS"));
		menuPictogramsHide.setText(TLanguage.getString("PICTOGRAMS_MENU_HIDE"));
		menuPictogramsHideBorder.setText(TLanguage
				.getString("PICTOGRAMS_MENU_HIDE_BORDER"));
		menuPictogramsHideBorderActiveElement.setText(TLanguage
				.getString("PICTOGRAMS_MENU_HIDE_BORDER_ACTIVE_ELEMENT"));
		menuPictogramsHideBorderAllElements.setText(TLanguage
				.getString("PICTOGRAMS_MENU_HIDE_BORDER_ALL_ELEMENTS"));
		menuPictogramsHideImage.setText(TLanguage
				.getString("PICTOGRAMS_MENU_HIDE_IMAGE"));
		menuPictogramsHideImageActiveElement.setText(TLanguage
				.getString("PICTOGRAMS_MENU_HIDE_IMAGE_ACTIVE_ELEMENT"));
		menuPictogramsHideImageAllElements.setText(TLanguage
				.getString("PICTOGRAMS_MENU_HIDE_IMAGE_ALL_ELEMENTS"));
		menuPictogramsShow.setText(TLanguage.getString("PICTOGRAMS_MENU_SHOW"));
		menuPictogramsShowBorder.setText(TLanguage
				.getString("PICTOGRAMS_MENU_SHOW_BORDER"));
		menuPictogramsShowBorderActiveElement.setText(TLanguage
				.getString("PICTOGRAMS_MENU_SHOW_BORDER_ACTIVE_ELEMENT"));
		menuPictogramsShowBorderAllElements.setText(TLanguage
				.getString("PICTOGRAMS_MENU_SHOW_BORDER_ALL_ELEMENTS"));
		menuPictogramsShowImage.setText(TLanguage
				.getString("PICTOGRAMS_MENU_SHOW_IMAGE"));
		menuPictogramsShowImageActiveElement.setText(TLanguage
				.getString("PICTOGRAMS_MENU_SHOW_IMAGE_ACTIVE_ELEMENT"));
		menuPictogramsShowImageAllElements.setText(TLanguage
				.getString("PICTOGRAMS_MENU_SHOW_IMAGE_ALL_ELEMENTS"));

		menuTools.setText(TLanguage.getString("TOOLS_MENU"));
		menuToolsResourceManager.setText(TLanguage
				.getString("TOOLS_MENU_RESOURCE_MANAGER"));

		menuToolsGeneralPreferences.setText(TLanguage
				.getString("TOOLS_MENU_GENERAL_PREFERENCES"));
		...
		generalPreferencesDialog.setTitle(TLanguage
				.getString("GENERAL_PREFERENCES_DIALOG_TITLE"));
		generalPreferencesDialogApplicationLanguageLabel
				.setText(TLanguage
						.getString("GENERAL_PREFERENCES_DIALOG_APPLICATION_LANGUAGE_LABEL"));
		generalPreferencesDialogDocumentLanguageLabel
				.setText(TLanguage
						.getString("GENERAL_PREFERENCES_DIALOG_DOCUMENT_LANGUAGE_LABEL"));
		generalPreferencesDialogImagesSizeLabel.setText(TLanguage
				.getString("GENERAL_PREFERENCES_DIALOG_IMAGES_SIZE_LABEL"));
		generalPreferencesDialogImageBordersSizeLabel
				.setText(TLanguage
						.getString("GENERAL_PREFERENCES_DIALOG_IMAGES_BORDERS_SIZE_LABEL"));
		...
		generalPreferencesDialogTextFontLabel.setText(TLanguage
				.getString("GENERAL_PREFERENCES_DIALOG_TEXT_FONT_LABEL"));
		generalPreferencesDialogChooseTextFontButton
				.setText(TLanguage
						.getString("GENERAL_PREFERENCES_DIALOG_TEXT_FONT_CHOOSE_BUTTON"));
		generalPreferencesDialogTextColorLabel.setText(TLanguage
				.getString("GENERAL_PREFERENCES_DIALOG_TEXT_COLOR_LABEL"));
		generalPreferencesDialogChooseTextColorButton.setText(TLanguage
						.getString("GENERAL_PREFERENCES_DIALOG_TEXT_COLOR_CHOOSE_BUTTON"));
		//arasuiteITA
		generalPreferencesDialogIconBorderColorLabel.setText(TLanguage
				.getString("GENERAL_PREFERENCES_DIALOG_ICON_BORDER_COLOR_LABEL"));
		generalPreferencesDialogChooseIconBorderColorButton.setText(TLanguage
						.getString("GENERAL_PREFERENCES_DIALOG_ICON_BORDER_COLOR_CHOOSE_BUTTON"));
		generalPreferencesDialogTextPlacementLabel.setText(TLanguage
		...
		documentLanguageDialog.setTitle(TLanguage
				.getString("DOCUMENT_LANGUAGE_DIALOG_TITLE"));
		documentLanguageDialogDocumentLanguageLabel.setText(TLanguage
				.getString("DOCUMENT_LANGUAGE_DIALOG_DOCUMENT_LANGUAGE_LABEL"));
		documentLanguageDialogOKButton.setText(TLanguage.getString("OK"));
		documentLanguageDialogCancelButton.setText(TLanguage
				.getString("CANCEL"));

		imagesSizeDialog.setTitle(TLanguage
				.getString("IMAGES_SIZE_DIALOG_TITLE"));
		imagesSizeDialogImagesSizeLabel.setText(TLanguage
				.getString("IMAGES_SIZE_DIALOG_IMAGES_SIZE_LABEL"));
		imagesSizeDialogOKButton.setText(TLanguage.getString("OK"));
		imagesSizeDialogCancelButton.setText(TLanguage.getString("CANCEL"));

		exportPDFDialog
				.setTitle(TLanguage.getString("EXPORT_PDF_DIALOG_TITLE"));
		exportPDFDialogExportButton.setText(TLanguage
				.getString("EXPORT_PDF_BUTTON"));
		exportPDFDialogCancelButton.setText(TLanguage.getString("CANCEL"));
		exportPDFDialogPictosLineLabel.setText(TLanguage
				.getString("EXPORT_PDF_PICTOS_LINE"));
		exportPDFDialogArasaacLicenseCB.setText(TLanguage
				.getString("EXPORT_PDF_ARASAAC_LICENSE"));
		exportPDFDialogPagLabel.setText(TLanguage.getString("EXPORT_PDF_PAGE"));
		exportPDFDialogPrevLabel.setText(TLanguage
				.getString("EXPORT_PDF_PREVISUALIZATION"));
		...
		str = str
				+ "# Colegio Público de Educación Especial Alborada (CPEE Alborada)\n";
		str = str
				+ "# Portal Aragonés de la Comunicación Aumentativa y Alternativa (ARASAAC)\n";
		str = str + "--- " + TLanguage.getString("TAboutDialog.YEAR")
				+ " 2013 ---\n";
		str = str + "--- " + TLanguage.getString("TAboutDialog.LICENSE")
				+ " GPL v3 ---\n\n";
		str = str
				+ "******* Pictogramas ARASAAC (http://arasaac.org) *******\n\n";
		...
		toolBarButtonPictogramsNextImage.setToolTipText(menuPictogramsNextImage
				.getText());
		toolBarButtonPictogramsCompoundSplitWord
		...
		// In future, it could not be "fixed" but instead depend of language
		// chosen:
		...
		((DefaultComboBoxModel) generalPreferencesDialogSpinnerApplicationLanguage
				.getModel()).removeAllElements();
		for (int i = 0; i < G.applicationLanguages.length; i++) {
			generalPreferencesDialogSpinnerApplicationLanguage
					.addItem(G.applicationLanguages[i]);
		}

		((DefaultComboBoxModel) generalPreferencesDialogSpinnerDocumentLanguage
				.getModel()).removeAllElements();
		for (int i = 0; i < G.documentLanguages.length; i++) {
			generalPreferencesDialogSpinnerDocumentLanguage
					.addItem(G.documentLanguages[i]);
		}
		...
		for (int i = 0; i < G.documentLanguages.length; i++) {
			documentLanguageDialogComboBoxDocumentLanguage
					.addItem(G.documentLanguages[i]);
		}

		String textPlacement[] = new String[] {
				TLanguage.getString("SPINNER_TEXT_BELOW_PICTOGRAM"),
				TLanguage.getString("SPINNER_TEXT_ABOVE_PICTOGRAM") };
		if (generalPreferencesDialogSpinnerTextPlacement.getItemCount() == 0) // TODO
																				// luca
																				// baco
																				// append
																				// menu
			...
			for (int i = 0; i < textPlacement.length; i++) {
				generalPreferencesDialogSpinnerTextPlacement
		...
		generalPreferencesDialogSpinnerDocumentLanguage
				.setSelectedItem(G.defaultDocumentLanguage);
		generalPreferencesDialogSpinnerApplicationLanguage
				.setSelectedItem(G.applicationLanguage);
		if (G.textBelowPictogram) {
			generalPreferencesDialogSpinnerTextPlacement
					.setSelectedItem(TLanguage
							.getString("SPINNER_TEXT_BELOW_PICTOGRAM"));
		} else {
			generalPreferencesDialogSpinnerTextPlacement
					.setSelectedItem(TLanguage
							.getString("SPINNER_TEXT_ABOVE_PICTOGRAM"));
		}

		documentLanguageDialogComboBoxDocumentLanguage
				.setSelectedItem(G.documentLanguage);
	}
	...
	private void initComponents() {
		...
		// generalPreferencesDialogSpinnerMaxUndoLevel = new
		// javax.swing.JSpinner();
		// generalPreferencesDialogMaxLengthCompoundWordsLabel = new
		// javax.swing.JLabel();
		// generalPreferencesDialogSpinnerMaxLengthCompoundWords = new
		// javax.swing.JSpinner();
		...
		// generalPreferencesDialogPictogramsPathLabel = new
		// javax.swing.JLabel();
		// generalPreferencesDialogChoosePictogramsPathButton = new
		// javax.swing.JButton();
		...
		generalPreferencesDialogIconBorderColorLabel = new javax.swing.JLabel();
		generalPreferencesDialogChooseIconBorderColorButton = new javax.swing.JButton();
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				.getInstance(araword.AraWordApp.class).getContext()
				.getResourceMap(GUI.class);
		...
		mainPanelLayout.setHorizontalGroup(mainPanelLayout.createParallelGroup(
				...
				mainPanelLayout
						...
						.add(scrollTextZone,
								...
								859, Short.MAX_VALUE).addContainerGap()));
		mainPanelLayout.setVerticalGroup(mainPanelLayout.createParallelGroup(
				...
				mainPanelLayout
						...
						.add(scrollTextZone,
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
								524, Short.MAX_VALUE).addContainerGap()));
		...
		menuFileExportImage.setText(resourceMap
				.getString("menuFileExportImage.text")); // NOI18N
		...
		menuFileExportPDF.setText(resourceMap
				.getString("menuFileExportPDF.text")); // NOI18N
		...
		menuEditSelectAll.setText(resourceMap
				.getString("menuEditSelectAll.text")); // NOI18N
		...
		menuTextPlacement.setText(resourceMap
				.getString("menuTextPlacement.text")); // NOI18N
		menuTextPlacement.setName("menuTextPlacement"); // NOI18N

		menuTextPlacementAbovePictogram.setText(resourceMap
				.getString("menuTextPlacementAbovePictogram.text")); // NOI18N
		menuTextPlacementAbovePictogram
				.setName("menuTextPlacementAbovePictogram"); // NOI18N
		menuTextPlacementAbovePictogram
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		menuTextPlacementBelowPictogram.setText(resourceMap
				.getString("menuTextPlacementBelowPictogram.text")); // NOI18N
		menuTextPlacementBelowPictogram
				.setName("menuTextPlacementBelowPictogram"); // NOI18N
		menuTextPlacementBelowPictogram
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		menuTextToUpperCase.setText(resourceMap
				.getString("menuTextToUpperCase.text")); // NOI18N
		menuTextToUpperCase.setName("menuTextToUpperCase"); // NOI18N

		menuTextToUpperCaseActiveElement.setText(resourceMap
				.getString("menuTextToUpperCaseActiveElement.text")); // NOI18N
		menuTextToUpperCaseActiveElement
				.setName("menuTextToUpperCaseActiveElement"); // NOI18N
		menuTextToUpperCaseActiveElement
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		menuTextToUpperCaseAllElements.setText(resourceMap
				.getString("menuTextToUpperCaseAllElements.text")); // NOI18N
		menuTextToUpperCaseAllElements
				.setName("menuTextToUpperCaseAllElements"); // NOI18N
		menuTextToUpperCaseAllElements
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		menuTextToLowerCase.setText(resourceMap
				.getString("menuTextToLowerCase.text")); // NOI18N
		menuTextToLowerCase.setName("menuTextToLowerCase"); // NOI18N

		menuTextToLowerCaseActiveElement.setText(resourceMap
				.getString("menuTextToLowerCaseActiveElement.text")); // NOI18N
		menuTextToLowerCaseActiveElement
				.setName("menuTextToLowerCaseActiveElement"); // NOI18N
		menuTextToLowerCaseActiveElement
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		menuTextToLowerCaseAllElements.setText(resourceMap
				.getString("menuTextToLowerCaseAllElements.text")); // NOI18N
		menuTextToLowerCaseAllElements
				.setName("menuTextToLowerCaseAllElements"); // NOI18N
		menuTextToLowerCaseAllElements
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		menuTextDocumentLanguage.setText(resourceMap
				.getString("menuTextDocumentLanguage.text")); // NOI18N
		menuTextDocumentLanguage.setName("menuTextDocumentLanguage"); // NOI18N
		menuTextDocumentLanguage
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		menuPictogramsSize.setText(resourceMap
				.getString("menuPictogramsSize.text")); // NOI18N
		...
		menuPictogramsNextImage.setText(resourceMap
				.getString("menuPictogramsNextImage.text")); // NOI18N
		menuPictogramsNextImage.setName("menuPictogramsNextImage"); // NOI18N
		menuPictogramsNextImage
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		menuPictogramsCompoundSplitWord.setText(resourceMap
				.getString("menuPictogramsCompoundSplitWord.text")); // NOI18N
		menuPictogramsCompoundSplitWord
				.setName("menuPictogramsCompoundSplitWord"); // NOI18N
		menuPictogramsCompoundSplitWord
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		menuPictogramsChangeName.setText(resourceMap
				.getString("menuPictogramsChangeName.text")); // NOI18N
		menuPictogramsChangeName.setName("menuPictogramsChangeName"); // NOI18N
		menuPictogramsChangeName
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		menuPictogramsShowImage.setText(resourceMap
				.getString("menuPictogramsShowImage.text")); // NOI18N
		menuPictogramsShowImage.setName("menuPictogramsShowImage"); // NOI18N

		menuPictogramsShowImageActiveElement.setText(resourceMap
				.getString("menuPictogramsShowImageActiveElement.text")); // NOI18N
		menuPictogramsShowImageActiveElement
				.setName("menuPictogramsShowImageActiveElement"); // NOI18N
		menuPictogramsShowImageActiveElement
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		menuPictogramsShowImageAllElements.setText(resourceMap
				.getString("menuPictogramsShowImageAllElements.text")); // NOI18N
		menuPictogramsShowImageAllElements
				.setName("menuPictogramsShowImageAllElements"); // NOI18N
		menuPictogramsShowImageAllElements
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		menuPictogramsShowBorder.setText(resourceMap
				.getString("menuPictogramsShowBorder.text")); // NOI18N
		menuPictogramsShowBorder.setName("menuPictogramsShowBorder"); // NOI18N

		menuPictogramsShowBorderActiveElement.setText(resourceMap
				.getString("menuPictogramsShowBorderActiveElement.text")); // NOI18N
		menuPictogramsShowBorderActiveElement
				.setName("menuPictogramsShowBorderActiveElement"); // NOI18N
		menuPictogramsShowBorderActiveElement
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		menuPictogramsShowBorderAllElements.setText(resourceMap
				.getString("menuPictogramsShowBorderAllElements.text")); // NOI18N
		menuPictogramsShowBorderAllElements
				.setName("menuPictogramsShowBorderAllElements"); // NOI18N
		menuPictogramsShowBorderAllElements
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		menuPictogramsHide.setText(resourceMap
				.getString("menuPictogramsHide.text")); // NOI18N
		menuPictogramsHide.setName("menuPictogramsHide"); // NOI18N

		menuPictogramsHideImage.setText(resourceMap
				.getString("menuPictogramsHideImage.text")); // NOI18N
		menuPictogramsHideImage.setName("menuPictogramsHideImage"); // NOI18N

		menuPictogramsHideImageActiveElement.setText(resourceMap
				.getString("menuPictogramsHideImageActiveElement.text")); // NOI18N
		menuPictogramsHideImageActiveElement
				.setName("menuPictogramsHideImageActiveElement"); // NOI18N
		menuPictogramsHideImageActiveElement
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		menuPictogramsHideImageAllElements.setText(resourceMap
				.getString("menuPictogramsHideImageAllElements.text")); // NOI18N
		menuPictogramsHideImageAllElements
				.setName("menuPictogramsHideImageAllElements"); // NOI18N
		menuPictogramsHideImageAllElements
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		menuPictogramsHideBorder.setText(resourceMap
				.getString("menuPictogramsHideBorder.text")); // NOI18N
		menuPictogramsHideBorder.setName("menuPictogramsHideBorder"); // NOI18N

		menuPictogramsHideBorderActiveElement.setText(resourceMap
				.getString("menuPictogramsHideBorderActiveElement.text")); // NOI18N
		menuPictogramsHideBorderActiveElement
				.setName("menuPictogramsHideBorderActiveElement"); // NOI18N
		menuPictogramsHideBorderActiveElement
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		menuPictogramsHideBorderAllElements.setText(resourceMap
				.getString("menuPictogramsHideBorderAllElements.text")); // NOI18N
		menuPictogramsHideBorderAllElements
				.setName("menuPictogramsHideBorderAllElements"); // NOI18N
		menuPictogramsHideBorderAllElements
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		menuToolsResourceManager.setText(resourceMap
				.getString("menuToolsResourceManager.text")); // NOI18N
		menuToolsResourceManager.setName("menuToolsResourceManager"); // NOI18N
		menuToolsResourceManager
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		// change: 02/02/12: just disable the option in order the data base be
		// handled
		...
		menuToolsGeneralPreferences.setText(resourceMap
				.getString("menuToolsGeneralPreferences.text")); // NOI18N
		menuToolsGeneralPreferences.setName("menuToolsGeneralPreferences"); // NOI18N
		menuToolsGeneralPreferences
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		menuVoiceSintesys.setText(resourceMap
				.getString("menuPictogramsNextImage.text")); // NOI18N
		...
		menuHelpShowHelp
				.setText(resourceMap.getString("menuHelpShowHelp.text")); // NOI18N
		...
		aboutDialog.setCursor(new java.awt.Cursor(
				java.awt.Cursor.DEFAULT_CURSOR));
		aboutDialog.setModal(true);
		aboutDialog.setName("aboutDialog"); // NOI18N
		aboutDialog.setResizable(false);

		aboutDialogCloseButton.setText(resourceMap
				.getString("aboutDialogCloseButton.text")); // NOI18N
		...
		aboutDialogImage
				.setText(resourceMap.getString("aboutDialogImage.text")); // NOI18N
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(aboutDialogImage,
				org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 702,
				Short.MAX_VALUE));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				org.jdesktop.layout.GroupLayout.TRAILING, aboutDialogImage,
				org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 234,
				Short.MAX_VALUE));
		...
		findDialogFindTextLabel.setText(resourceMap
				.getString("findDialogFindTextLabel.text")); // NOI18N
		findDialogFindTextLabel.setName("findDialogFindTextLabel"); // NOI18N

		findDialogTextField.setText(resourceMap
				.getString("findDialogTextField.text")); // NOI18N
		findDialogTextField.setName("findDialogTextField"); // NOI18N

		findDialogFindButton.setText(resourceMap
				.getString("findDialogFindButton.text")); // NOI18N
		findDialogFindButton.setName("findDialogFindButton"); // NOI18N
		findDialogFindButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		findDialogExitButton.setText(resourceMap
				.getString("findDialogExitButton.text")); // NOI18N
		findDialogExitButton.setName("findDialogExitButton"); // NOI18N
		findDialogExitButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		org.jdesktop.layout.GroupLayout findDialogLayout = new org.jdesktop.layout.GroupLayout(
				findDialog.getContentPane());
		findDialog.getContentPane().setLayout(findDialogLayout);
		findDialogLayout
				.setHorizontalGroup(findDialogLayout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
						.add(findDialogLayout
								.createSequentialGroup()
								.addContainerGap()
								.add(findDialogLayout
										.createParallelGroup(
								...
								.addContainerGap(
										...
										Short.MAX_VALUE)));
		findDialogLayout
				.setVerticalGroup(findDialogLayout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
						.add(findDialogLayout
								.createSequentialGroup()
		...
		generalPreferencesDialogSpinnerImagesSize
				.setModel(new javax.swing.SpinnerNumberModel(100, 25, 500, 5));
		generalPreferencesDialogSpinnerImagesSize
				.setName("generalPreferencesDialogSpinnerImagesSize"); // NOI18N

		generalPreferencesDialogSpinnerImageBorderSize
				.setModel(new javax.swing.SpinnerNumberModel(3, 0, 100, 1));
		generalPreferencesDialogSpinnerImageBorderSize
				.setName("generalPreferencesDialogSpinnerImageBorderSize"); // NOI18N

		generalPreferencesDialogImagesSizeLabel.setText(resourceMap
				.getString("generalPreferencesDialogImagesSizeLabel.text")); // NOI18N
		generalPreferencesDialogImagesSizeLabel
				.setName("generalPreferencesDialogImagesSizeLabel"); // NOI18N

		generalPreferencesDialogImageBordersSizeLabel
				.setText(resourceMap
						.getString("generalPreferencesDialogImageBordersSizeLabel.text")); // NOI18N
		generalPreferencesDialogImageBordersSizeLabel
				.setName("generalPreferencesDialogImageBordersSizeLabel"); // NOI18N
		...
		// generalPreferencesDialogSpinnerMaxUndoLevel.setModel(new
		...
		// generalPreferencesDialogSpinnerMaxLengthCompoundWords.setModel(new
		// javax.swing.SpinnerNumberModel(3, 0, 5, 1));
		// generalPreferencesDialogSpinnerMaxLengthCompoundWords.setName("generalPreferencesDialogSpinnerMaxLengthCompoundWords");
		// // NOI18N

		generalPreferencesDialogApplicationLanguageLabel
				.setText(resourceMap
						.getString("generalPreferencesDialogApplicationLanguageLabel.text")); // NOI18N
		generalPreferencesDialogApplicationLanguageLabel
				.setName("generalPreferencesDialogApplicationLanguageLabel"); // NOI18N

		/*
		 * String languages[] = new String[] {"Español", "English", "Français",
		 * "Deutsch", "Català"}; for (int i = 0; i < languages.length; i++) {
		 * generalPreferencesDialogSpinnerApplicationLanguage
		 * .addItem(languages[i]); }
		 * generalPreferencesDialogSpinnerApplicationLanguage
		 * .setName("generalPreferencesDialogSpinnerApplicationLanguage"); //
		 * NOI18N
		 */

		generalPreferencesDialogDocumentLanguageLabel
				.setText(resourceMap
						.getString("generalPreferencesDialogDocumentLanguageLabel.text")); // NOI18N
		generalPreferencesDialogDocumentLanguageLabel
				.setName("generalPreferencesDialogDocumentLanguageLabel"); // NOI18N

		/*
		 * String documentLanguages[] = new String[] {"(todos)", "Español",
		 * "English", "Français", "Deutsch", "Català"}; for (int i = 0; i <
		 * documentLanguages.length; i++) {
		 * generalPreferencesDialogSpinnerDocumentLanguage
		 * .addItem(documentLanguages[i]); }
		 * generalPreferencesDialogSpinnerDocumentLanguage
		 * .setName("generalPreferencesDialogSpinnerDocumentLanguage"); //
		 * NOI18N
		 */

		generalPreferencesDialogOKButton.setText(resourceMap
				.getString("generalPreferencesDialogOKButton.text")); // NOI18N
		generalPreferencesDialogOKButton
				.setName("generalPreferencesDialogOKButton"); // NOI18N
		generalPreferencesDialogOKButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		generalPreferencesDialogCancelButton.setText(resourceMap
				.getString("generalPreferencesDialogCancelButton.text")); // NOI18N
		generalPreferencesDialogCancelButton
				.setName("generalPreferencesDialogCancelButton"); // NOI18N
		generalPreferencesDialogCancelButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		// // NOI18N
		// generalPreferencesDialogChoosePictogramsPathButton.addActionListener(new
		...
		generalPreferencesDialogTextFontLabel.setText(resourceMap
				.getString("generalPreferencesDialogTextFontLabel.text")); // NOI18N
		generalPreferencesDialogTextFontLabel
				.setName("generalPreferencesDialogTextFontLabel"); // NOI18N

		generalPreferencesDialogChooseTextFontButton
				.setText(resourceMap
						.getString("generalPreferencesDialogChooseTextFontButton.text")); // NOI18N
		generalPreferencesDialogChooseTextFontButton
				.setName("generalPreferencesDialogChooseTextFontButton"); // NOI18N
		generalPreferencesDialogChooseTextFontButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		generalPreferencesDialogTextColorLabel.setText(resourceMap
				.getString("generalPreferencesDialogTextColorLabel.text")); // NOI18N
		generalPreferencesDialogTextColorLabel
				.setName("generalPreferencesDialogTextColorLabel"); // NOI18N

		generalPreferencesDialogChooseTextColorButton
				.setText(resourceMap
						.getString("generalPreferencesDialogChooseTextColorButton.text")); // NOI18N
		generalPreferencesDialogChooseTextColorButton
				.setName("generalPreferencesDialogChooseTextColorButton"); // NOI18N
		generalPreferencesDialogChooseTextColorButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		generalPreferencesDialogChooseIconBorderColorButton.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				generalPreferencesDialogChooseIconBorderColorButtonActionPerformed(evt);
			}
		});
		
		generalPreferencesDialogTextPlacementLabel.setText(resourceMap
				.getString("generalPreferencesDialogTextPlacementLabel.text")); // NOI18N
		generalPreferencesDialogTextPlacementLabel
				.setName("generalPreferencesDialogTextPlacementLabel"); // NOI18N

		/*
		 * String textPlacement[] = new String[] {"Encima del pictograma",
		 * "Debajo del pictograma"}; for (int i = 0; i < textPlacement.length;
		 * i++) {
		 * generalPreferencesDialogSpinnerTextPlacement.addItem(textPlacement
		 * [i]); } generalPreferencesDialogSpinnerTextPlacement.setName(
		 * "generalPreferencesDialogSpinnerTextPlacement"); // NOI18N
		 */

		org.jdesktop.layout.GroupLayout generalPreferencesDialogLayout = new org.jdesktop.layout.GroupLayout(
				generalPreferencesDialog.getContentPane());
		generalPreferencesDialog.getContentPane().setLayout(
				generalPreferencesDialogLayout);
		generalPreferencesDialogLayout
				.setHorizontalGroup(generalPreferencesDialogLayout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
						.add(generalPreferencesDialogLayout
								...
								.add(generalPreferencesDialogLayout
										...
										.add(generalPreferencesDialogLayout
												...
												.add(generalPreferencesDialogLayout
														.createParallelGroup(
																org.jdesktop.layout.GroupLayout.LEADING)
														.add(generalPreferencesDialogSpinnerImagesSize,
																org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
																151,
																Short.MAX_VALUE)
														.add(generalPreferencesDialogSpinnerImageBorderSize,
																org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
																151,
																Short.MAX_VALUE)
														...
														// org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
														// 151, Short.MAX_VALUE)
														.add(generalPreferencesDialogSpinnerDocumentLanguage,
																org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
																151,
																Short.MAX_VALUE)
														.add(generalPreferencesDialogSpinnerApplicationLanguage,
																org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
																151,
																Short.MAX_VALUE)
												// .add(generalPreferencesDialogSpinnerMaxLengthCompoundWords,
												// org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
												// 151, Short.MAX_VALUE)
												// .add(generalPreferencesDialogSpinnerMaxUndoLevel,
												// org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
												// 151, Short.MAX_VALUE)
												))
										.add(generalPreferencesDialogTextFontLabel)
										.add(generalPreferencesDialogTextColorLabel)
										.add(generalPreferencesDialogIconBorderColorLabel)
										.add(generalPreferencesDialogLayout
												.createSequentialGroup()
												.add(generalPreferencesDialogLayout
														.createParallelGroup(
												...
												.add(generalPreferencesDialogLayout
														...
														.add(org.jdesktop.layout.GroupLayout.TRAILING,
																...
																Short.MAX_VALUE)
														.add(org.jdesktop.layout.GroupLayout.TRAILING,
																generalPreferencesDialogChooseIconBorderColorButton,
																org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
																153,
																Short.MAX_VALUE)
														.add(org.jdesktop.layout.GroupLayout.TRAILING,
								...
								.addContainerGap()));
		generalPreferencesDialogLayout
				.setVerticalGroup(generalPreferencesDialogLayout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
						.add(generalPreferencesDialogLayout
								.createSequentialGroup()
								...
								.add(generalPreferencesDialogLayout
										.createParallelGroup(
												org.jdesktop.layout.GroupLayout.BASELINE)
										.add(generalPreferencesDialogIconBorderColorLabel)
										.add(generalPreferencesDialogChooseIconBorderColorButton))
								.addPreferredGap(
										org.jdesktop.layout.LayoutStyle.UNRELATED)
								.add(generalPreferencesDialogLayout
										.createParallelGroup(
												org.jdesktop.layout.GroupLayout.BASELINE)
										.add(generalPreferencesDialogTextPlacementLabel)
										.add(generalPreferencesDialogSpinnerTextPlacement,
												org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
												org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
												org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
								.add(34, 34, 34)
								.add(generalPreferencesDialogLayout
										.createParallelGroup(
												org.jdesktop.layout.GroupLayout.BASELINE)
										.add(generalPreferencesDialogTTSLabel)
										.add(generalPreferencesDialogSpinnerTTS,
												org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
												org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
												org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
								.add(34, 34, 34)
		...
		toolBarButtonFileNew.setText(resourceMap
				.getString("toolBarButtonFileNew.text")); // NOI18N
		...
		toolBarButtonPictogramsNextImage.setText(resourceMap
				.getString("toolBarButtonPictogramsNextImage.text")); // NOI18N
		toolBarButtonPictogramsNextImage.setFocusable(false);
		toolBarButtonPictogramsNextImage
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		toolBarButtonPictogramsNextImage
				.setName("toolBarButtonPictogramsNextImage"); // NOI18N
		toolBarButtonPictogramsNextImage
				.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
		toolBarButtonPictogramsNextImage
				.addActionListener(new java.awt.event.ActionListener() {
		...
		toolBarButtonPictogramsCompoundSplitWord.setText(resourceMap
				.getString("toolBarButtonPictogramsCompoundSplitWord.text")); // NOI18N
		toolBarButtonPictogramsCompoundSplitWord.setFocusable(false);
		toolBarButtonPictogramsCompoundSplitWord
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		toolBarButtonPictogramsCompoundSplitWord
				.setName("toolBarButtonPictogramsCompoundSplitWord"); // NOI18N
		toolBarButtonPictogramsCompoundSplitWord
				.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
		toolBarButtonPictogramsCompoundSplitWord
				.addActionListener(new java.awt.event.ActionListener() {
		...
		toolBarButtonVoiceSintesys.setText(resourceMap
				.getString("toolBarButtonVoiceSintesys.text")); // NOI18N
		toolBarButtonVoiceSintesys.setFocusable(false);
		toolBarButtonVoiceSintesys
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		...
		documentLanguageDialogDocumentLanguageLabel.setText(resourceMap
				.getString("documentLanguageDialogDocumentLanguageLabel.text")); // NOI18N
		documentLanguageDialogDocumentLanguageLabel
				.setName("documentLanguageDialogDocumentLanguageLabel"); // NOI18N

		// documentLanguageDialogSpinnerDocumentLanguage.setModel(new
		// javax.swing.SpinnerListModel(new String[] {"(todos)", "Español",
		// "English", "Français", "Deutsch", "Català"}));
		// documentLanguageDialogSpinnerDocumentLanguage.setName("documentLanguageDialogSpinnerDocumentLanguage");
		// // NOI18N

		// String[] languages = new String[] {"(todos)", "Español", "English",
		// "Français", "Deutsch", "Català"};
		// for (int i = 0; i < languages.length; i++) {
		// documentLanguageDialogComboBoxDocumentLanguage.addItem(languages[i]);
		// }

		documentLanguageDialogOKButton.setText(resourceMap
				.getString("documentLanguageDialogOKButton.text")); // NOI18N
		documentLanguageDialogOKButton
				.setName("documentLanguageDialogOKButton"); // NOI18N
		documentLanguageDialogOKButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		documentLanguageDialogCancelButton.setText(resourceMap
				.getString("documentLanguageDialogCancelButton.text")); // NOI18N
		documentLanguageDialogCancelButton
				.setName("documentLanguageDialogCancelButton"); // NOI18N
		documentLanguageDialogCancelButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		org.jdesktop.layout.GroupLayout documentLanguageDialogLayout = new org.jdesktop.layout.GroupLayout(
				documentLanguageDialog.getContentPane());
		documentLanguageDialog.getContentPane().setLayout(
				documentLanguageDialogLayout);
		documentLanguageDialogLayout
				.setHorizontalGroup(documentLanguageDialogLayout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
						.add(documentLanguageDialogLayout
								.createSequentialGroup()
								.addContainerGap()
								.add(documentLanguageDialogLayout
										.createParallelGroup(
										...
										.add(documentLanguageDialogLayout
												...
												.add(documentLanguageDialogDocumentLanguageLabel,
														...
														Short.MAX_VALUE)
												.add(35, 35, 35)
												.add(documentLanguageDialogComboBoxDocumentLanguage,
														org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
														154, Short.MAX_VALUE))
										.add(org.jdesktop.layout.GroupLayout.TRAILING,
												documentLanguageDialogLayout
								...
								.addContainerGap()));
		documentLanguageDialogLayout
				.setVerticalGroup(documentLanguageDialogLayout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
						.add(documentLanguageDialogLayout
								.createSequentialGroup()
		...
		imagesSizeDialogImagesSizeLabel.setText(resourceMap
				.getString("imagesSizeDialogImagesSizeLabel.text")); // NOI18N
		imagesSizeDialogImagesSizeLabel
				.setName("imagesSizeDialogImagesSizeLabel"); // NOI18N

		imagesSizeDialogSpinnerImagesSize
				.setModel(new javax.swing.SpinnerNumberModel(100, 25, 500, 5));
		imagesSizeDialogSpinnerImagesSize
				.setName("imagesSizeDialogSpinnerImagesSize"); // NOI18N

		imagesSizeDialogCancelButton.setText(resourceMap
				.getString("imagesSizeDialogCancelButton.text")); // NOI18N
		imagesSizeDialogCancelButton.setName("imagesSizeDialogCancelButton"); // NOI18N
		imagesSizeDialogCancelButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		imagesSizeDialogOKButton.setText(resourceMap
				.getString("imagesSizeDialogOKButton.text")); // NOI18N
		imagesSizeDialogOKButton.setName("imagesSizeDialogOKButton"); // NOI18N
		imagesSizeDialogOKButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		org.jdesktop.layout.GroupLayout imagesSizeDialogLayout = new org.jdesktop.layout.GroupLayout(
				imagesSizeDialog.getContentPane());
		imagesSizeDialog.getContentPane().setLayout(imagesSizeDialogLayout);
		imagesSizeDialogLayout
				.setHorizontalGroup(imagesSizeDialogLayout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
						.add(imagesSizeDialogLayout
								.createSequentialGroup()
								.addContainerGap()
								.add(imagesSizeDialogLayout
										.createParallelGroup(
								...
								.add(imagesSizeDialogLayout
										.createParallelGroup(
												org.jdesktop.layout.GroupLayout.LEADING)
										.add(imagesSizeDialogSpinnerImagesSize,
												org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
												93, Short.MAX_VALUE)
								...
								.addContainerGap()));
		imagesSizeDialogLayout
				.setVerticalGroup(imagesSizeDialogLayout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
						.add(imagesSizeDialogLayout
								.createSequentialGroup()
		...
		exportPDFDialogPictosLineLabel
				.setName("exportPDFDialogPictosLineLabel"); // NOI18N

		exportPDFDialogSpinnerPictosLine
				.setModel(new javax.swing.SpinnerNumberModel(5, 1, 10, 1));
		exportPDFDialogSpinnerPictosLine
				.setName("exportPDFDialogSpinnerPictosLine"); // NOI18N
		exportPDFDialogSpinnerPictosLine
				.addChangeListener(new javax.swing.event.ChangeListener() {

					public void stateChanged(javax.swing.event.ChangeEvent arg0) {
						G.numPictosLinePDF = ((Integer) exportPDFDialogSpinnerPictosLine
								.getValue()).intValue();
						G.imagesSize = 200 / G.numPictosLinePDF;

						araword.utils.TextUtils
								.regeneratePDFPrevZone(exportPDFDialogPrevArea,
										((Integer) exportPDFDialogPagSpinner
												.getValue()).intValue());
						// System.out.println("Picto linea: " + ((Integer)
						// exportPDFDialogSpinnerPictosLine.getValue()).intValue());
					}
				});

		exportPDFDialogPagSpinner.setModel(new javax.swing.SpinnerNumberModel(
				1, 1, 50, 1));
		exportPDFDialogPagSpinner.setName("exportPDFDialogPagSpinner"); // NOI18N
		exportPDFDialogPagSpinner
				.addChangeListener(new javax.swing.event.ChangeListener() {
					public void stateChanged(javax.swing.event.ChangeEvent arg0) {
						int page = ((Integer) exportPDFDialogPagSpinner
								.getValue()).intValue();
						araword.utils.TextUtils.regeneratePDFPrevZone(
								exportPDFDialogPrevArea, page);

					}
				});

		exportPDFDialogArasaacLicenseCB.setSelected(G.licensePDF);
		exportPDFDialogArasaacLicenseCB
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
						G.licensePDF = exportPDFDialogArasaacLicenseCB
								.isSelected();
					}
				});

		exportPDFDialogCancelButton.setName("exportPDFDialogCancelButton"); // NOI18N
		exportPDFDialogCancelButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		org.jdesktop.layout.GroupLayout exportPDFDialogLayout = new org.jdesktop.layout.GroupLayout(
				exportPDFDialog.getContentPane());
		exportPDFDialog.getContentPane().setLayout(exportPDFDialogLayout);

		// pruebas de añadir componentes
		exportPDFDialogLayout
				.setHorizontalGroup(exportPDFDialogLayout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
						.add(org.jdesktop.layout.GroupLayout.TRAILING,
								exportPDFDialogLayout
										...
										.add(exportPDFDialogLayout
												...
												.add(exportPDFDialogLayout
														...
														.addPreferredGap(
																org.jdesktop.layout.LayoutStyle.UNRELATED)
														.add(exportPDFDialogSpinnerPictosLine,
																org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
										...
										.add(exportPDFDialogLayout
												...
												.add(exportPDFDialogLayout
														...
														.addPreferredGap(
																org.jdesktop.layout.LayoutStyle.RELATED)
														.add(exportPDFDialogPagSpinner,
																org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
																org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
																org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
										.addContainerGap()));
		exportPDFDialogLayout
				.setVerticalGroup(exportPDFDialogLayout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
						.add(exportPDFDialogLayout
								.createSequentialGroup()
		 ...
		 * exportPDFDialogLayout.createParallelGroup
		 * (org.jdesktop.layout.GroupLayout.LEADING)
		 * .add(exportPDFDialogLayout.createSequentialGroup() .addContainerGap()
		 * .add(exportPDFDialogPictosLineLabel)
		 * .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
		 * .add(exportPDFDialogSpinnerPictosLine,
		 * org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
		 * org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
		 * org.jdesktop.layout.GroupLayout.PREFERRED_SIZE) .addContainerGap(449,
		 * Short.MAX_VALUE)) ); exportPDFDialogLayout.setVerticalGroup(
		 * exportPDFDialogLayout
		 * .createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		 * .add(exportPDFDialogLayout.createSequentialGroup() .add(49, 49, 49)
		 * .add(exportPDFDialogLayout.createParallelGroup(org.jdesktop.layout.
		 * GroupLayout.BASELINE) .add(exportPDFDialogPictosLineLabel)
		 * .add(exportPDFDialogSpinnerPictosLine,
		 * org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
		 * org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
		 * org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
		 ...
		 * .add(exportPDFDialogLayout.createSequentialGroup() .addContainerGap()
		 * .add(exportPDFDialogLayout.createParallelGroup(org.jdesktop.layout.
		 * GroupLayout.LEADING, false) .add(exportPDFDialogExportButton,
		 * org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
		 ...
		 * .createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		 * .add(exportPDFDialogSpinnerPictosLine,
		 * org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 93, Short.MAX_VALUE)
		 * .add(exportPDFDialogCancelButton,
		 * org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 93, Short.MAX_VALUE))
		 * .addContainerGap()) );
		 * 
		 ...
		 * .add(imagesSizeDialogLayout
		 * .createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
		 * .add(exportPDFDialogExportButton) .add(exportPDFDialogCancelButton))
	...
	private void menuFileNewActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuFileNewActionPerformed
		if (JOptionPane.showConfirmDialog(getFrame(),
				TLanguage.getString("FILE_MENU_WARNING_DISCARD"),
	...
	private void menuFileExportPDFActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuFileExportActionPerformed
		...
		araword.utils.TextUtils.regeneratePDFPrevZone(exportPDFDialogPrevArea,
				1);
		exportPDFDialog.setModal(true);
		exportPDFDialog.setLocationRelativeTo(null); // Center window on the
	...
	private void menuEditFindActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuEditFindActionPerformed
		...
		findDialog.setLocationRelativeTo(null); // Center window on the middle
												// of the screen.
		findDialog.setVisible(true);
	}// GEN-LAST:event_menuEditFindActionPerformed

	private void findDialogFindButtonActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_findDialogFindButtonActionPerformed
		...
		if (strToFind.equals("")) {
			...
			JOptionPane.showMessageDialog(null, TLanguage
					.getString("EDIT_MENU_FIND_UNABLE_EMPTY_STRING_SEARCH"),
					TLanguage.getString("WARNING"),
		...
		if (wholeText.indexOf(strToFind) == -1)
			return; // String to find is not on text.
		...
		for (int i = G.lastPositionFound + 1; i < G.elementList.size(); i++) {
			...
			if (elem.getType() == 0) {
				...
				if (wordText.length() >= strToFind.length()) {
					...
					// If we use startWith instead of indexOf, we'll miss search
					// hits like
					// search "abc ddddd" in a sequence of words:
					// "fffabc dddddwer".
						...
						while (!stop) {
							if (tmpPos < G.elementList.size()) {
								...
								if (words.length() >= strToFind.length()) {
									// Search "abc de f" in a sequence of words
									// like "abc de f ghij"
									if (words.indexOf(strToFind) != -1) { // Found
																			// word!!
										G.lastPositionFound = i;
										somethingFound = true;
										break searchLoop;
		...
		if (somethingFound) {
			G.elementList.get(G.lastPositionFound).getTextField()
					.requestFocusInWindow();
		} else {
			JOptionPane.showMessageDialog(null,
					TLanguage.getString("EDIT_MENU_FIND_NOT_FOUND_TEXT"),
					TLanguage.getString("WARNING"),
					JOptionPane.INFORMATION_MESSAGE);
			G.lastPositionFound = -1;
		}
	...
	private void findDialogExitButtonActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_findDialogExitButtonActionPerformed
		findDialog.setVisible(false);
	...
	private void menuTextPlacementAbovePictogramActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuTextPlacementAbovePictogramActionPerformed
		G.textBelowPictogram = false;
		TextUtils.regenerateDocument();
	}// GEN-LAST:event_menuTextPlacementAbovePictogramActionPerformed

	private void menuTextPlacementBelowPictogramActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuTextPlacementBelowPictogramActionPerformed
		G.textBelowPictogram = true;
		TextUtils.regenerateDocument();
	}// GEN-LAST:event_menuTextPlacementBelowPictogramActionPerformed

	private void menuTextToUpperCaseActiveElementActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuTextToUpperCaseActiveElementActionPerformed
		MenuFunctions.pictogramToUpperCaseActiveElement();
	}// GEN-LAST:event_menuTextToUpperCaseActiveElementActionPerformed

	private void menuTextToUpperCaseAllElementsActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuTextToUpperCaseAllElementsActionPerformed
		MenuFunctions.pictogramToUpperCaseAllElements();
	}// GEN-LAST:event_menuTextToUpperCaseAllElementsActionPerformed

	private void menuTextToLowerCaseActiveElementActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuTextToLowerCaseActiveElementActionPerformed
		MenuFunctions.pictogramToLowerCaseActiveElement();
	}// GEN-LAST:event_menuTextToLowerCaseActiveElementActionPerformed

	private void menuTextToLowerCaseAllElementsActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuTextToLowerCaseAllElementsActionPerformed
		MenuFunctions.pictogramToLowerCaseAllElements();
	}// GEN-LAST:event_menuTextToLowerCaseAllElementsActionPerformed

	private void menuTextDocumentLanguageActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuTextDocumentLanguageActionPerformed
		documentLanguageDialog.pack();
		documentLanguageDialog.setModal(true);
		documentLanguageDialog.setLocationRelativeTo(null); // Center window on
															// the middle of the
															// screen.
		documentLanguageDialog.setVisible(true);
	}// GEN-LAST:event_menuTextDocumentLanguageActionPerformed

	private void documentLanguageDialogCancelButtonActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_documentLanguageDialogCancelButtonActionPerformed
		documentLanguageDialog.setVisible(false);
	}// GEN-LAST:event_documentLanguageDialogCancelButtonActionPerformed

	private void documentLanguageDialogOKButtonActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_documentLanguageDialogOKButtonActionPerformed
		G.documentLanguage = (String) documentLanguageDialogComboBoxDocumentLanguage
				.getSelectedItem();
		DBManagement.connectVerbsDB();
		DBManagement.createAraWordView(G.documentLanguage);
		TextUtils.regenerateDocument();
	...
	private void menuPictogramsSizeActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuPictogramsSizeActionPerformed
		imagesSizeDialog.pack();
		imagesSizeDialog.setModal(true);
		imagesSizeDialog.setLocationRelativeTo(null); // Center window on the
														// middle of the screen.
		imagesSizeDialog.setVisible(true);
	}// GEN-LAST:event_menuPictogramsSizeActionPerformed

	private void imagesSizeDialogCancelButtonActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_imagesSizeDialogCancelButtonActionPerformed
		imagesSizeDialog.setVisible(false);
	}// GEN-LAST:event_imagesSizeDialogCancelButtonActionPerformed

	private void imagesSizeDialogOKButtonActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_imagesSizeDialogOKButtonActionPerformed
		System.out.println("##### CAMBIADO TAMAÑO #####");
		G.imagesSize = ((Integer) imagesSizeDialogSpinnerImagesSize.getValue())
				.intValue();
		ImageIcon image = new ImageIcon("resources/404.jpg");
		G.notFound = new ImageIcon(image.getImage().getScaledInstance(-1,
				G.imagesSize, 0));
		TextUtils.regenerateDocument();
		imagesSizeDialog.setVisible(false);
	}// GEN-LAST:event_imagesSizeDialogOKButtonActionPerformed

	private void exportPDFDialogCancelButtonActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_imagesSizeDialogCancelButtonActionPerformed
		G.imagesSize = G.imagesSizePDF;
		exportPDFDialog.setVisible(false);
	}// GEN-LAST:event_imagesSizeDialogCancelButtonActionPerformed

	private void exportPDFDialogExportButtonActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_imagesSizeDialogCancelButtonActionPerformed
		// G.imagesSize=G.imagesSizePDF;
	...
	private void menuPictogramsNextImageActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuPictogramsNextImageActionPerformed
		MenuFunctions.pictogramNextImage();
	}// GEN-LAST:event_menuPictogramsNextImageActionPerformed

	private void menuPictogramsCompoundSplitWordActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuPictogramsCompoundSplitWordActionPerformed
		MenuFunctions.pictogramCompoundSplit();
	}// GEN-LAST:event_menuPictogramsCompoundSplitWordActionPerformed

	private void menuPictogramsChangeNameActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuPictogramsChangeNameActionPerformed
		MenuFunctions.pictogramChangeName();
	}// GEN-LAST:event_menuPictogramsChangeNameActionPerformed

	private void menuPictogramsShowBorderAllElementsActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuPictogramsShowBorderAllElementsActionPerformed
		MenuFunctions.pictogramShowBorderAllElements();
	}// GEN-LAST:event_menuPictogramsShowBorderAllElementsActionPerformed

	private void menuPictogramsHideBorderAllElementsActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuPictogramsHideBorderAllElementsActionPerformed
		MenuFunctions.pictogramHideBorderAllElements();
	}// GEN-LAST:event_menuPictogramsHideBorderAllElementsActionPerformed

	private void menuPictogramsShowImageActiveElementActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuPictogramsShowImageActiveElementActionPerformed
		MenuFunctions.pictogramShowImageActiveElement();
	}// GEN-LAST:event_menuPictogramsShowImageActiveElementActionPerformed

	private void menuPictogramsShowImageAllElementsActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuPictogramsShowImageAllElementsActionPerformed
		MenuFunctions.pictogramShowImageAllElements();
	}// GEN-LAST:event_menuPictogramsShowImageAllElementsActionPerformed

	private void menuPictogramsShowBorderActiveElementActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuPictogramsShowBorderActiveElementActionPerformed
		MenuFunctions.pictogramShowBorderActiveElement();
	}// GEN-LAST:event_menuPictogramsShowBorderActiveElementActionPerformed

	private void menuPictogramsHideImageActiveElementActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuPictogramsHideImageActiveElementActionPerformed
		MenuFunctions.pictogramHideImageActiveElement();
	}// GEN-LAST:event_menuPictogramsHideImageActiveElementActionPerformed

	private void menuPictogramsHideImageAllElementsActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuPictogramsHideImageAllElementsActionPerformed
		MenuFunctions.pictogramHideImageAllElements();
	}// GEN-LAST:event_menuPictogramsHideImageAllElementsActionPerformed

	private void menuPictogramsHideBorderActiveElementActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuPictogramsHideBorderActiveElementActionPerformed
		MenuFunctions.pictogramHideBorderActiveElement();
	}// GEN-LAST:event_menuPictogramsHideBorderActiveElementActionPerformed

	private void menuToolsResourceManagerActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuToolsResourceManagerActionPerformed
		try {
			Runtime.getRuntime().exec(
					"java -jar ." + File.separator + ".." + File.separator
							+ "ResourceManager" + File.separator
							+ "ResourceManager.jar");
		} catch (Exception e) {
	...
	private void menuToolsGeneralPreferencesActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_menuToolsGeneralPreferencesActionPerformed
		generalPreferencesDialog.pack();
		generalPreferencesDialog.setLocationRelativeTo(null); // Center window
																// on the middle
																// of the
																// screen.
	...
	private void generalPreferencesDialogOKButtonActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_generalPreferencesDialogOKButtonActionPerformed
		G.defaultTextBelowPictogram = ((String) generalPreferencesDialogSpinnerTextPlacement
				.getSelectedItem()).equals(TLanguage
				.getString("SPINNER_TEXT_BELOW_PICTOGRAM"));
		G.defaultImagesSize = ((Integer) generalPreferencesDialogSpinnerImagesSize
				.getValue()).intValue();
		G.iconsBorderSize = ((Integer) generalPreferencesDialogSpinnerImageBorderSize
				.getValue()).intValue();
		// G.maxLengthCompoundWords =
		// ((Integer)generalPreferencesDialogSpinnerMaxLengthCompoundWords.getValue()).intValue();
		// G.maxUndoLevel =
		// ((Integer)generalPreferencesDialogSpinnerMaxUndoLevel.getValue()).intValue();
		G.applicationLanguage = ((String) generalPreferencesDialogSpinnerApplicationLanguage
				.getSelectedItem());
		G.defaultDocumentLanguage = ((String) generalPreferencesDialogSpinnerDocumentLanguage
				.getSelectedItem());
		G.documentLanguage = ((String) generalPreferencesDialogSpinnerDocumentLanguage
				.getSelectedItem());
	...
	private void generalPreferencesDialogCancelButtonActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_generalPreferencesDialogCancelButtonActionPerformed
		generalPreferencesDialog.setVisible(false);
	}// GEN-LAST:event_generalPreferencesDialogCancelButtonActionPerformed

	private void generalPreferencesDialogChooseTextFontButtonActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_generalPreferencesDialogChooseTextFontButtonActionPerformed
		JFontChooser fontChooser = new JFontChooser();
		if (fontChooser.showDialog(null) == JFontChooser.OK_OPTION) {
			Font font = fontChooser.getSelectedFont();
	...
	// private void
	// generalPreferencesDialogChoosePictogramsPathButtonActionPerformed(java.awt.event.ActionEvent
	// evt)
	// {//GEN-FIRST:event_generalPreferencesDialogChoosePictogramsPathButtonActionPerformed
	// try {
	// JFileChooser fc = new JFileChooser(".");
	// fc.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
	// if (fc.showOpenDialog(G.textZone) == JFileChooser.APPROVE_OPTION) {
	// File file = fc.getSelectedFile();
	// // Use external class RelativePath to obtain relative path (i.e
	// ..\pictograms).
	...
	private void toolBarButtonFileNewActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_toolBarButtonFileNewActionPerformed
		if (JOptionPane.showConfirmDialog(getFrame(),
				TLanguage.getString("FILE_MENU_WARNING_DISCARD"),
				TLanguage.getString("WARNING"), JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
			TextUtils.newDocument();
	...
	private void toolBarButtonFileOpenActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_toolBarButtonFileOpenActionPerformed
		if (JOptionPane.showConfirmDialog(getFrame(),
				TLanguage.getString("FILE_MENU_WARNING_DISCARD"),
				TLanguage.getString("WARNING"), JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
			MenuFunctions.fileOpen();
	...
	private void toolBarButtonFileSaveActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_toolBarButtonFileSaveActionPerformed
		MenuFunctions.fileSave();
	}// GEN-LAST:event_toolBarButtonFileSaveActionPerformed

	private void toolBarButtonEditUndoActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_toolBarButtonEditUndoActionPerformed
		MenuFunctions.editUndo();
	}// GEN-LAST:event_toolBarButtonEditUndoActionPerformed

	private void toolBarButtonEditRedoActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_toolBarButtonEditRedoActionPerformed
		MenuFunctions.editRedo();
	}// GEN-LAST:event_toolBarButtonEditRedoActionPerformed

	private void toolBarButtonEditCutActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_toolBarButtonEditCutActionPerformed
		MenuFunctions.editCut();
	}// GEN-LAST:event_toolBarButtonEditCutActionPerformed

	private void toolBarButtonEditCopyActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_toolBarButtonEditCopyActionPerformed
		MenuFunctions.editCopy();
	}// GEN-LAST:event_toolBarButtonEditCopyActionPerformed

	private void toolBarButtonEditPasteActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_toolBarButtonEditPasteActionPerformed
		MenuFunctions.editPaste(G.activeElementPosition + 1);
	}// GEN-LAST:event_toolBarButtonEditPasteActionPerformed

	private void toolBarButtonPictogramsNextImageActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_toolBarButtonPictogramsNextImageActionPerformed
		MenuFunctions.pictogramNextImage();
	}// GEN-LAST:event_toolBarButtonPictogramsNextImageActionPerformed

	private void toolBarButtonPictogramsCompoundSplitWordActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_toolBarButtonPictogramsCompoundSplitWordActionPerformed
		MenuFunctions.pictogramCompoundSplit();
	}// GEN-LAST:event_toolBarButtonPictogramsCompoundSplitWordActionPerformed

	private void toolBarButtonPictogramsChangeNameActionPerformed(
	...
	private void toolBarButtonVoiceSintesysActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_toolBarButtonPictogramsInsertImageActionPerformed
		MenuFunctions.VoiceSintesys();
	}// GEN-LAST:event_toolBarButtonPictogramsInsertImageActionPerformed

	private void generalPreferencesDialogChooseTextColorButtonActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_generalPreferencesDialogChooseTextColorButtonActionPerformed
	...
	private void generalPreferencesDialogChooseIconBorderColorButtonActionPerformed(
			java.awt.event.ActionEvent evt) {
		Color tmp = JColorChooser.showDialog(null, "", Color.BLACK);
		// I set the chosen color as the default for all category to allow further save
        if(G.borders != null)
        {
        	for (Map.Entry<String, Border> entry : G.borders.entrySet())
        	{
        		entry.setValue(new CompoundBorder(new EmptyBorder(5,5,5,5),BorderFactory.createLineBorder(tmp,G.iconsBorderSize)));
        	}
        }
	}
	...
	private void aboutDialogCloseButtonActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_aboutDialogCloseButtonActionPerformed
	...
	public JPanel createProgressDialog() {
		...
		center_panel.setBorder(new TitledBorder(BorderFactory
	...
	// generalPreferencesDialogChoosePictogramsPathButton;
	private javax.swing.JButton generalPreferencesDialogChooseTextColorButton;
	private javax.swing.JButton generalPreferencesDialogChooseIconBorderColorButton;
	...
	// generalPreferencesDialogMaxLengthCompoundWordsLabel;
	...
	// generalPreferencesDialogSpinnerMaxLengthCompoundWords;
	...
	private javax.swing.JLabel generalPreferencesDialogIconBorderColorLabel;
