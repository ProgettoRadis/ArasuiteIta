/*
 * File: TIGManageImageAction.java
...
public class TIGManageImageAction extends TIGAbstractAction{
    ...
    public void actionPerformed(ActionEvent e) {
        /*
         * TIGDataBase.conectDB(); Vector<Vector<String>> data =
         * TIGDataBase.imageSearchByName("*"); if (data.size() > 0) new
         * TIGModifyImageDialog(getEditor(), dataBase); else
