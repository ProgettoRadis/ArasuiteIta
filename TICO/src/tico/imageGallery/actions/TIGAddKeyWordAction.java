 ...
 */
public class TIGAddKeyWordAction extends TIGAbstractAction {
	 ...
	 */
	public TIGAddKeyWordAction(TEditor editor, String text, TIGDataBase dataBase) {
		super(editor);
		this.editor = editor;
	...
	public void actionPerformed(ActionEvent e) {
		TIGDataBase.insertConceptDB(text);
	}
