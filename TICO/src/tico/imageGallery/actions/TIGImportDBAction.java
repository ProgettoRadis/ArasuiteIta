...
import tico.imageGallery.dialogs.TIGImportDBDialog;
...
public class TIGImportDBAction extends TIGAbstractAction{
	 ...
	 */
	public TIGImportDBAction(TEditor editor,TIGDataBase dataBase) {
		//super(editor);
	...
	public void actionPerformed(ActionEvent e) {
		//new TIGImportDBDialog(getEditor(), dataBase);
