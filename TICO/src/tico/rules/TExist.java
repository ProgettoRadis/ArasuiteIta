...
public class TExist {
	...
	/**
	 * Creates a new empty <code>TExist</code> with no initial attributes.
	 */
	public TExist() {
	}
	...
	/**
	 * Creates a new empty <code>TExist</code> with the specified initial
	...
	/**
	 * Returns the TExist <code>name</code>.
	 * 
	 * @return The TExist <code>name</code>
	 */
	...
	/**
	 * Sets the TExist <code>name</code>.
	 * 
	 * @param name The TExist <code>name</code> to set
	 */
	...
	/**
	 * Returns the TExist <code>of</code>.
	 * 
	 * @return The TExist <code>of</code>
	 */
	public String getOf() {
		return of;
	}
	...
	/**
	 * Sets the TExist <code>of</code>.
	 * 
	 * @param of The TExist <code>of</code> to set
	 */
	...
	/**
	 * Returns the TExist <code>attribute</code>.
	 * 
	 * @return The TExist <code>attribute</code>
	 */
	...
	/**
	 * Returns the TExist <code>parameter</code>.
	 * 
	 * @return The TExist <code>parameter</code>
	 */
	...
	/**
	 * Returns the TExist <code>message</code>.
	 * 
	 * @return The TExist <code>message</code>
	 */
	...
	/**
	 * Sets the TExist <code>message</code>.
	 * 
	 * @param message The TExist <code>message</code> to set
	 */
