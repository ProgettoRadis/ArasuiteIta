 ...
 */
public class TCell extends TComponent {
	/**
	 ...
	 */
	public String newId() { 
		return "cell_" + new Integer(cellCount++);
	}
...
/*	public Node XMLEncodeAndroid(Document doc) {
		// Create component node
		Element componentElement = doc.createElement("cell");
		componentElement.setAttribute("type", TYPE);
		...
		// Append component attributes
		//componentElement.appendChild(TAttributeEncoder.XMLEncode(map, doc));
		componentElement.setAttribute("margin_left", "20" );
	 ...
	 */
	public static TCell XMLDecode(Element element) throws InvalidFormatException {
