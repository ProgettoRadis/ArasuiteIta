...
/**
 * Defines a <code>TRectangle</code> and its attributes.
 *
 * @author Pablo Muñoz
 * @version 1.0 Nov 20, 2006
 */
public class TRectangle extends TComponent {
	/**
	 * The <code>TRectangle</code> type used as attribute in XML encoding and decoding.
	 */
	...
	/**
	 * Creates a new <code>TRectangle</code>.
	 */
	public TRectangle() {
		super();
	...
	/* (non-Javadoc)
	 * @see tico.board.components.TDraw#newId()
	 */
	public String newId() {
    	return "rectangle_" + new Integer(rectangleCount++);
	}
	...
	/**
	 * Returns a <code>TRectangle</code> object from the data contained in
	 * the XML <code>Element</code>.
	 * 
	 * @param element The XML <code>Element</code> that contains the rectangle data
	 * @return The generated <code>TRectangle</code>
	 * @throws InvalidFormatException If <code>Element</code> has an invalid format
	 */
	public static TRectangle XMLDecode(Element element) throws InvalidFormatException {
		if (element.getTagName().equals("component")
			...
			Node attributesNode = element.getElementsByTagName("attributes")
					.item(0);
			// Apply attributes to the rectangle
			rectangle.getAttributes().applyMap(TAttributeEncoder
