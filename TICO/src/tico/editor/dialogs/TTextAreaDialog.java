...
/**
 * Dialog to change <code>TTextAreaDialog</code> attributes.
 * 
 * @author Pablo Muñoz
 * @version 1.0 Nov 20, 2006
 */
public class TTextAreaDialog extends TComponentDialog {
	...
	/**
	 * Creates a new <code>TTextAreaDialog</code> to edit the <code>textArea</code>
	 * properties.
	 * 
	 * @param boardContainer The <code>boardContainer</code> which contains the
	 * cell to be edited
	 * @param textArea The <code>textArea</code> to be edited
	 */
	...
	private void createTabbedPane() {
		...
		tabbedPane.addTab(TLanguage.getString("TTextAreaDialog.TAB_TEXT"),
				textPropertiesPanel);
		tabbedPane.addTab(TLanguage.getString("TTextAreaDialog.TAB_PROPERTIES"),
	...
	private void createTextPropertiesPanel() {
		...
		c.gridx = 0;
		c.gridy = 1;
		textPropertiesPanel.add(textAlignSelectorPanel, c);
	...
	private void createTextAlignSelector() {
		...
		textAlignSelectorPanel.setHorizontalAlignment(TBoardConstants
				.getHorizontalAlignment(map));
		textAlignSelectorPanel.setVerticalAlignment(TBoardConstants
				.getVerticalAlignment(map));
	}
	...
	protected Map newComponentsAttributeMap() {
		...
		TBoardConstants.setHorizontalAlignment(attributeMap,
				textAlignSelectorPanel.getHorizontalAlignment());
		TBoardConstants.setVerticalAlignment(attributeMap,
				textAlignSelectorPanel.getVerticalAlignment());
