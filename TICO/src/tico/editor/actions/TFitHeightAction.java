 ...
 */
public class TFitHeightAction extends TEditorAbstractAction {
	/**
	 * Constructor of the TFitHeightAction.
	 * 
	 * @param editor The boards' editor
	 */
	public TFitHeightAction(TEditor editor) {
		super(editor, TLanguage.getString("TFitHeightAction.NAME"),
				TResourceManager.getImageIcon("align-height-22.png"));
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		for (int i = 1; i < selectedCellsCount; i++) {
			...
			newBounds.setFrame(currentBounds.getX(),currentBounds.getY(),
					currentBounds.getWidth(),referenceBounds.getHeight());
