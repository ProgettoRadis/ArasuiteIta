/*
 * File: TBoardAbstractAction.java
 ...
 */
public abstract class TBoardAbstractAction extends AbstractAction {
	/**
	...
	/**
	 * Constructor for TBoardAbstractAction. The Abstract action uses the class
	 ...
	 * 
	 * @param editor
	 *            The reference to the TEditor for this action
	 * @see Action#NAME
	 * 
	 */
	 ...
	 * 
	 * @param name
	 *            Key for the name of this action
	 */

	public TBoardAbstractAction(String name) {
		super(name);
	}
	...
	public TBoardAbstractAction(TEditor editor, String name) {
		super(name);
		this.editor = editor;
	}
	...
	public TBoardAbstractAction(TEditor editor, String name, Icon icon) {
		super(name, icon);
		this.editor = editor;
	}
