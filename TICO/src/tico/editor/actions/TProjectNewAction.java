 ...
 */
public class TProjectNewAction extends TEditorAbstractAction {
	/**
	 * Constructor for TProjectNewAction.
	 * 
	 * @param editor The boards' editor
	 */
	public TProjectNewAction(TEditor editor) {
		super(editor, TLanguage.getString("TProjectNewAction.NAME"),
				TResourceManager.getImageIcon("archive-new-22.png"));
	}
