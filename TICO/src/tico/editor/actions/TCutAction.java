 ...
 */
public class TCutAction extends TEditorAbstractAction {
	/**
	 * Constructor for TCutAction.
	 * 
	 * @param editor The boards' editor
	 */
	public TCutAction(TEditor editor) {
		super(editor, TLanguage.getString("TCutAction.NAME"),
				TResourceManager.getImageIcon("edit-cut-22.png"));
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		// Unselect any TGridCell, each TGrid with a TGridCell selected will be cut
