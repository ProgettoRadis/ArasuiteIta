...
/**
 * Action wich align the right side of all the editor's current selected
 * components.
 * 
 * @author Pablo Muñoz
 * @version 1.0 Nov 20, 2006
 */
public class TAlignRightAction extends TEditorAbstractAction {
	/**
	 * Constructor of the TAlignRightAction.
	 * 
	 * @param editor The boards' editor
	 */
	public TAlignRightAction(TEditor editor) {
		super(editor, TLanguage.getString("TAlignRightAction.NAME"),
				TResourceManager.getImageIcon("align-right-22.png"));
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		for (int i = 1; i < selectedCellsCount; i++) {
			...
			newBounds = new Rectangle2D.Double(
					referenceBounds.getX() + referenceBounds.getWidth() - currentBounds.getWidth(),
