...
/**
 * Action wich align the left side of all the editor's current selected
 * components.
 * 
 * @author Pablo Muñoz
 * @version 1.0 Nov 20, 2006
 */
public class TAlignLeftAction extends TEditorAbstractAction {
	/**
	 * Constructor of the TAlignLeftAction.
	 * 
	 * @param editor The boards' editor
	 */
	public TAlignLeftAction(TEditor editor) {
		super(editor, TLanguage.getString("TAlignLeftAction.NAME"),
				TResourceManager.getImageIcon("align-left-22.png"));
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		for (int i = 1; i < selectedCellsCount; i++) {
			...
			newBounds = new Rectangle2D.Double(referenceBounds.getX(),currentBounds.getY(),
