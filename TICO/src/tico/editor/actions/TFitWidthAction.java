...
public class TFitWidthAction extends TEditorAbstractAction {
	...
	public TFitWidthAction(TEditor editor) {
		super(editor, TLanguage.getString("TFitWidthAction.NAME"),
				TResourceManager.getImageIcon("align-width-22.png"));
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		for (int i = 1; i < selectedCellsCount; i++) {
			...
			newBounds.setFrame(currentBounds.getX(),currentBounds.getY(),
					referenceBounds.getWidth(),currentBounds.getHeight());
