 ...
 */
public class TSoundChooser extends JPanel {
	// TImageChooser default constructor parameters
	private final static String DEFAULT_TITLE = TLanguage.getString("TSoundChooser.TITLE");
	...
	private TInterpreterMidSound pruebaMid=null;
	 ...
	 */
	public TSoundChooser(String title) {
		super();
	...
	private void playSoundFile() {
		...
		{
			 pruebaMid= new TInterpreterMidSound(soundFilePath);
			 pruebaMid.start();
