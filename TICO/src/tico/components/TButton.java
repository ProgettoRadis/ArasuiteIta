...
/**
 * An implementation of a push button with the format parameters for Tico
 * applications.
 *
 * @author Pablo Muñoz
...
public class TButton extends JButton {
	...
	/**
	 * Creates a <code>TButton</code> with a <code>text</code>.
	 * 
	...
	/**
	 * Creates a <code>TButton</code> with an <code>icon</code>.
	 * 
	...
	/**
	 * Creates a <code>TButton</code> where properties are taken from the <code>action</code>
	 * supplied.
	 * 
