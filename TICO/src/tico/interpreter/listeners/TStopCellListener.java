...
public class TStopCellListener implements MouseListener {
	
	TInterpreter interpreter;

	public TStopCellListener() {
	...
	public void mousePressed(MouseEvent arg0) {
		if ((TInterpreter.run==1)){
			if(arg0.getButton()==MouseEvent.BUTTON3){ //Right button
				...
				TInterpreterStopAction stop = new TInterpreterStopAction(interpreter);
